<template>
  <div>
    <h5 class="mt-5 ml-5">성장단계: 1일차 방문</h5>
...
import HowToCare from '@/components/HowToCare.vue';
import WhatIsAttribute from '@/components/WhatIsAttribute.vue';
import WhatIsProperty from '@/components/WhatIsProperty.vue';
